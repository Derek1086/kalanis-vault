"""
Django settings for kalanisVault project.
...
ROOT_URLCONF = 'kalanisVault.urls'
...
WSGI_APPLICATION = 'kalanisVault.wsgi.application'
...
DEFAULT_FROM_EMAIL = "info@kalanis-vault.com"
DOMAIN = env("DOMAIN")
SITE_NAME = "KV"